بسیار عالی! در این بخش، می‌خواهیم به‌صورت **کامل و حرفه‌ای** با **بلوک `always` در Verilog** و مفهوم **لیست حساسیت (sensitivity list)** یا همان **sensor sensitivity** آشنا شویم.
